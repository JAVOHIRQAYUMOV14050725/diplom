...
const IPv4 = '213.230.91.183'; // Replace it with the Server Public IPv4 in production.
...
module.exports = {
    ...
    middleware: {
        ...
        */
        IpWhitelist: {
            enabled: false,
            allowed: ['127.0.0.1', '::1', '213.230.91.183'],
        },
    },
    api: {
    ...
    oidc: {
        ...
        */
        enabled: false,
        config: {
            issuerBaseURL: 'https://dev-rkbaozv0kx6gwyau.us.auth0.com',
            baseURL: `http://localhost:${process.env.PORT ? process.env.PORT : 3010}`, // https://sfu.mirotalk.com
            clientID: 'rKsBnnGHygbqENDbu5EEZJ1GmH5KRzQJ',
            clientSecret: 'j3BogqMot-JyJT1gsjAKLxO5Q1edHz8tcbVZG33VKpuRxHhViKDb_tlls5HTvvlH',
    ...
    ngrok: {
        ...
        */
        enabled: false,
        authToken: '2p6rDWYMIo8Iicsi7pexq1dYSXQ_3bFmuU2X3t7jEuhLb1Uqc',
    },
    sentry: {
        /*
        Sentry
    ...
    mediasoup: {
        ...
        webRtcServerOptions: {
            listenInfos: [
                ...
                { protocol: 'udp', ip: '0.0.0.0', announcedAddress: IPv4, portRange: { min: 40000, max: 40000 + numWorkers } },
                { protocol: 'tcp', ip: '0.0.0.0', announcedAddress: IPv4, portRange: { min: 40000, max: 40000 + numWorkers } },
            ],
        },
